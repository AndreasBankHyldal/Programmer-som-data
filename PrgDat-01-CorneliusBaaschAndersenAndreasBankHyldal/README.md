...
### Exercise 2.1 
We changed Let to take a list of bindings and updated eval to evaluate them sequentially before evaluating the body

### Exercise 2.2 
We updated freevars to handle sequential bindings, where each variable is bound only in later bindings and the body

### Exercise 2.3 
We updated tcomp to compile sequential bindings into nested TLet expressions while extending the compile-time environment
